...
export default function StockPage() {
    ...
    return (
        <Box sx={{ display: 'flex', bgcolor: theme.palette.background.default, minHeight: '100dvh', color: theme.palette.text.primary }}>
            <Sidebar />
            <Box sx={{ flexGrow: 1, maxWidth: 1600, mx: 'auto', pb: 10, pt: 6, pr: { xs: 2, md: 6 }, pl: { xs: 2, md: '120px' }, minWidth: 0 }}>
                {/* Back Button */}
                <Button
                ...
                <Grid container spacing={6}>
                    ...
                    <Grid size={{ xs: 12, md: 8 }}>
                        ...
                        {/* AI Verdict Card */}
                        <Box sx={{ p: 4, borderRadius: 4, background: mode === 'dark' ? 'linear-gradient(180deg, rgba(0, 229, 255, 0.05) 0%, rgba(0,0,0,0) 100%)' : 'linear-gradient(180deg, rgba(0, 150, 255, 0.03) 0%, rgba(255,255,255,0) 100%)', border: `1px solid ${theme.palette.divider}`, mb: 6 }}>
